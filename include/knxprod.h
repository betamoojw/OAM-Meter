...
#define MAIN_ParameterSize 2667
...
#define MTR_ParamBlockOffset 14
#define MTR_ParamBlockSize 46
...
#define MTR_ChannelOutModifier                   8      // float
#define MTR_ChannelInType                       16      // 4 Bits, Bit 7-4
#define     MTR_ChannelInTypeMask 0xF0
#define     MTR_ChannelInTypeShift 4
#define MTR_ChannelOutType                      16      // 4 Bits, Bit 3-0
#define     MTR_ChannelOutTypeMask 0x0F
#define     MTR_ChannelOutTypeShift 0
#define MTR_ChannelDurationType                 16      // 4 Bits, Bit 3-0
#define     MTR_ChannelDurationTypeMask 0x0F
#define     MTR_ChannelDurationTypeShift 0
#define MTR_ChannelMode                         24      // 4 Bits, Bit 7-4
#define     MTR_ChannelModeMask 0xF0
#define     MTR_ChannelModeShift 4
#define MTR_ChannelLock                         24      // 2 Bits, Bit 3-2
#define     MTR_ChannelLockMask 0x0C
#define     MTR_ChannelLockShift 2
#define MTR_ChannelBackstop                     25      // 1 Bit, Bit 7
#define     MTR_ChannelBackstopMask 0x80
#define     MTR_ChannelBackstopShift 7
#define MTR_ChannelPowerCalc                    25      // 1 Bit, Bit 6
#define     MTR_ChannelPowerCalcMask 0x40
#define     MTR_ChannelPowerCalcShift 6
#define MTR_ChannelIgnoreZero                   25      // 1 Bit, Bit 5
#define     MTR_ChannelIgnoreZeroMask 0x20
#define     MTR_ChannelIgnoreZeroShift 5
#define MTR_ChannelInDistance                   40      // uint16_t
#define MTR_ChannelInPulses                     42      // uint16_t
#define MTR_ChannelInFallback                   44      // uint16_t
...
// Leistungsberechung
#define ParamMTR_ChannelPowerCalc                    ((bool)(knx.paramByte(MTR_ParamCalcIndex(MTR_ChannelPowerCalc)) & MTR_ChannelPowerCalcMask))
// Ignoriere 0
...
#define MTR_KoChannelIn 1
#define MTR_KoChannelOut 2
#define MTR_KoChannelOpt 3
#define MTR_KoChannelReset 4

// 
#define KoMTR_ChannelIn                           (knx.getGroupObject(MTR_KoCalcNumber(MTR_KoChannelIn)))
// 
#define KoMTR_ChannelOut                          (knx.getGroupObject(MTR_KoCalcNumber(MTR_KoChannelOut)))
// 
#define KoMTR_ChannelOpt                          (knx.getGroupObject(MTR_KoCalcNumber(MTR_KoChannelOpt)))
// 
#define KoMTR_ChannelReset                        (knx.getGroupObject(MTR_KoCalcNumber(MTR_KoChannelReset)))

#define LOG_BuzzerInstalled                     934      // 1 Bit, Bit 7
#define     LOG_BuzzerInstalledMask 0x80
#define     LOG_BuzzerInstalledShift 7
#define LOG_LedInstalled                        934      // 1 Bit, Bit 6
#define     LOG_LedInstalledMask 0x40
#define     LOG_LedInstalledShift 6
#define LOG_VacationKo                          934      // 1 Bit, Bit 5
#define     LOG_VacationKoMask 0x20
#define     LOG_VacationKoShift 5
#define LOG_HolidayKo                           934      // 1 Bit, Bit 4
#define     LOG_HolidayKoMask 0x10
#define     LOG_HolidayKoShift 4
#define LOG_VacationRead                        934      // 1 Bit, Bit 3
#define     LOG_VacationReadMask 0x08
#define     LOG_VacationReadShift 3
#define LOG_HolidaySend                         934      // 1 Bit, Bit 2
#define     LOG_HolidaySendMask 0x04
#define     LOG_HolidaySendShift 2
#define LOG_Neujahr                             935      // 1 Bit, Bit 7
#define     LOG_NeujahrMask 0x80
#define     LOG_NeujahrShift 7
#define LOG_DreiKoenige                         935      // 1 Bit, Bit 6
#define     LOG_DreiKoenigeMask 0x40
#define     LOG_DreiKoenigeShift 6
#define LOG_Weiberfastnacht                     935      // 1 Bit, Bit 5
#define     LOG_WeiberfastnachtMask 0x20
#define     LOG_WeiberfastnachtShift 5
#define LOG_Rosenmontag                         935      // 1 Bit, Bit 4
#define     LOG_RosenmontagMask 0x10
#define     LOG_RosenmontagShift 4
#define LOG_Fastnachtsdienstag                  935      // 1 Bit, Bit 3
#define     LOG_FastnachtsdienstagMask 0x08
#define     LOG_FastnachtsdienstagShift 3
#define LOG_Aschermittwoch                      935      // 1 Bit, Bit 2
#define     LOG_AschermittwochMask 0x04
#define     LOG_AschermittwochShift 2
#define LOG_Frauentag                           935      // 1 Bit, Bit 1
#define     LOG_FrauentagMask 0x02
#define     LOG_FrauentagShift 1
#define LOG_Gruendonnerstag                     935      // 1 Bit, Bit 0
#define     LOG_GruendonnerstagMask 0x01
#define     LOG_GruendonnerstagShift 0
#define LOG_Karfreitag                          936      // 1 Bit, Bit 7
#define     LOG_KarfreitagMask 0x80
#define     LOG_KarfreitagShift 7
#define LOG_Ostersonntag                        936      // 1 Bit, Bit 6
#define     LOG_OstersonntagMask 0x40
#define     LOG_OstersonntagShift 6
#define LOG_Ostermontag                         936      // 1 Bit, Bit 5
#define     LOG_OstermontagMask 0x20
#define     LOG_OstermontagShift 5
#define LOG_TagDerArbeit                        936      // 1 Bit, Bit 4
#define     LOG_TagDerArbeitMask 0x10
#define     LOG_TagDerArbeitShift 4
#define LOG_Himmelfahrt                         936      // 1 Bit, Bit 3
#define     LOG_HimmelfahrtMask 0x08
#define     LOG_HimmelfahrtShift 3
#define LOG_Pfingstsonntag                      936      // 1 Bit, Bit 2
#define     LOG_PfingstsonntagMask 0x04
#define     LOG_PfingstsonntagShift 2
#define LOG_Pfingstmontag                       936      // 1 Bit, Bit 1
#define     LOG_PfingstmontagMask 0x02
#define     LOG_PfingstmontagShift 1
#define LOG_Fronleichnam                        936      // 1 Bit, Bit 0
#define     LOG_FronleichnamMask 0x01
#define     LOG_FronleichnamShift 0
#define LOG_Friedensfest                        937      // 1 Bit, Bit 7
#define     LOG_FriedensfestMask 0x80
#define     LOG_FriedensfestShift 7
#define LOG_MariaHimmelfahrt                    937      // 1 Bit, Bit 6
#define     LOG_MariaHimmelfahrtMask 0x40
#define     LOG_MariaHimmelfahrtShift 6
#define LOG_DeutscheEinheit                     937      // 1 Bit, Bit 5
#define     LOG_DeutscheEinheitMask 0x20
#define     LOG_DeutscheEinheitShift 5
#define LOG_Nationalfeiertag                    938      // 1 Bit, Bit 1
#define     LOG_NationalfeiertagMask 0x02
#define     LOG_NationalfeiertagShift 1
#define LOG_Reformationstag                     937      // 1 Bit, Bit 4
#define     LOG_ReformationstagMask 0x10
#define     LOG_ReformationstagShift 4
#define LOG_Allerheiligen                       937      // 1 Bit, Bit 3
#define     LOG_AllerheiligenMask 0x08
#define     LOG_AllerheiligenShift 3
#define LOG_BussBettag                          937      // 1 Bit, Bit 2
#define     LOG_BussBettagMask 0x04
#define     LOG_BussBettagShift 2
#define LOG_MariaEmpfaengnis                    938      // 1 Bit, Bit 0
#define     LOG_MariaEmpfaengnisMask 0x01
#define     LOG_MariaEmpfaengnisShift 0
#define LOG_Advent1                             937      // 1 Bit, Bit 1
#define     LOG_Advent1Mask 0x02
#define     LOG_Advent1Shift 1
#define LOG_Advent2                             937      // 1 Bit, Bit 0
#define     LOG_Advent2Mask 0x01
#define     LOG_Advent2Shift 0
#define LOG_Advent3                             938      // 1 Bit, Bit 7
#define     LOG_Advent3Mask 0x80
#define     LOG_Advent3Shift 7
#define LOG_Advent4                             938      // 1 Bit, Bit 6
#define     LOG_Advent4Mask 0x40
#define     LOG_Advent4Shift 6
#define LOG_Heiligabend                         938      // 1 Bit, Bit 5
#define     LOG_HeiligabendMask 0x20
#define     LOG_HeiligabendShift 5
#define LOG_Weihnachtstag1                      938      // 1 Bit, Bit 4
#define     LOG_Weihnachtstag1Mask 0x10
#define     LOG_Weihnachtstag1Shift 4
#define LOG_Weihnachtstag2                      938      // 1 Bit, Bit 3
#define     LOG_Weihnachtstag2Mask 0x08
#define     LOG_Weihnachtstag2Shift 3
#define LOG_Silvester                           938      // 1 Bit, Bit 2
#define     LOG_SilvesterMask 0x04
#define     LOG_SilvesterShift 2
#define LOG_BuzzerSilent                        939      // uint16_t
#define LOG_BuzzerNormal                        941      // uint16_t
#define LOG_BuzzerLoud                          943      // uint16_t
#define LOG_VisibleChannels                     945      // uint8_t
#define LOG_LedMapping                          946      // 3 Bits, Bit 7-5
...
// Parameter per channel
#define LOG_ParamBlockOffset 947
...
#define BASE_KommentarModuleParamOffset 2667
